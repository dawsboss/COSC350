...
void* fun2(void* x){
    return (void*) ((long)x + 20);
}

void* fun3(void* x){
    return (void*) ((long)x + 30);
}
...
int main(int argc, char** argv){
    ...
    if((rc = pthread_create(&threads[0], NULL, fun1, (void*)((long)atoi(argv[1]))))){
    ...
    printf("The thre thread's calculation result is: %ld\n", (long)num);
